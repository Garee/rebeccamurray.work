...
const snapshots = [
    ...
    },
    {
        ...
        description:
            "Daily UI design challenge day 9, design a music player. Designing a minimalist music player for an apple watch allowed me to implement neumorphism as a trend led feature. This trend is great for a simple music player as it keeps the app feeling soft and light, with a focus on mindfulness. With this I could utilise the apple watch face features. These effects were inspired by the early music players visual effects that would sync to the users current song playing.",
        rtl: true,
